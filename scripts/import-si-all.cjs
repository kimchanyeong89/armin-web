...
const MUSEUMS = [
  { 
    ...
    indexUrl: 'https://smithsonian-open-access.s3-us-west-2.amazonaws.com/metadata/edan/fsg/index.txt',
    output: 'si-asian-art.json',
    filterCategory: ['Painting', 'Drawing'] 
  },
  { 
    id: 'npg', 
    name: 'National Portrait Gallery', 
    indexUrl: 'https://smithsonian-open-access.s3-us-west-2.amazonaws.com/metadata/edan/npg/index.txt',
    output: 'si-npg.json',
    filterCategory: ['Painting', 'Drawing', 'Photograph']
  },
  { 
    id: 'nasm', 
