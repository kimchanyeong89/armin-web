...
// Usage: node scripts/upload-to-firebase.js ./downloads exhibitionId roomId
...
async function main(){
  ...
  if (!dir) { console.error('Usage: node scripts/upload-to-firebase.js <dir> [exhibitionId] [roomId]'); process.exit(1); }
