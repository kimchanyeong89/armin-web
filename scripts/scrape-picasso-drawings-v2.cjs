/**
 * Musée Picasso Paris - Drawings (Dessins) Collection Scraper v2
 * 
...
const SEARCH_URL = 'https://cep.museepicassoparis.fr/explorer?field_domaine%5Bdessins%5D=dessins&text=&sort-image=1';
...
const PROGRESS_FILE = path.join(PROGRESS_DIR, 'drawings-v2-progress.json');
 ...
 */
async function main() {
  console.log('🎨 Musée Picasso Paris - Drawings Collection Scraper v2');
