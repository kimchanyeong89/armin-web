/**
 * Rijksmuseum Prints Collection 2 Scraper - API 버전
 * Facet ID: b0bc3ade46385021a41bfd5a654172f5
 */
...
const OUTPUT_FILE = path.join(__dirname, '../public/data/rijksmuseum-prints2-collection.json');
const PROGRESS_FILE = path.join(__dirname, '../downloads/rijksmuseum-prints2-progress.json');
const LOG_FILE = path.join(__dirname, '../downloads/rijksmuseum-prints2-log.txt');
...
// Prints 2 facet ID
const FACET_ID = 'b0bc3ade46385021a41bfd5a654172f5';
...
async function main() {
  log('🖼️ Rijksmuseum Prints Collection 2 Scraper - API 버전');
  log('='.repeat(60));
