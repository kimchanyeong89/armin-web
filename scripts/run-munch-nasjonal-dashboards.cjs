...
const targets = [
    { name: 'Munchmuseet', file: 'munch-collection.json', script: 'scripts/upload-munch-to-r2.cjs' },
    { name: 'Nasjonal', file: 'nasjonal-collection.json', script: 'scripts/upload-nasjonal-to-r2.cjs' }
];
...
const interval = setInterval(() => {
    ...
    output += '\x1b[1m\x1b[32m   🚀  MUNCH & NASJONAL UPLOAD DASHBOARD (CLOUDFLARE) 🚀\x1b[0m\n';
    output += '\x1b[36m=============================================================\x1b[0m\n\n';
