/**
 * Castello di Rivoli Full Scraper v3 - Puppeteer version (more stable)
 */
...
const PROGRESS_FILE = path.join(__dirname, '../downloads/rivoli-v3-progress.json');
...
async function main() {
  console.log('=== Castello di Rivoli Full Scraper v3 (Puppeteer) ===\n');
  ...
  try {
    ...
    console.log(`\nScraping ${remaining.length} remaining artworks...\n`);
