/**
 * Musée Picasso Paris - Prints Collection Scraper
 * 
 * 피카소 미술관 파리 - 판화/인쇄물 컬렉션 스크래핑 (Estampes)
 */
...
const PROGRESS_FILE = path.join(PROGRESS_DIR, 'prints-progress.json');
