...
(async () => {
    ...
    // User requested: images=y, media=painting, sort_by=artist
    ...
    for (let p = 1; p <= maxPages; p++) {
        ...
        const items = await page.evaluate(() => {
            ...
            // Try specific selectors for AGNSW which uses .card
            // We use a broad selector for cards container
        ...
        // Dedup: ensure we don't add items with same ID
