/**
 * Musée Picasso Paris - Paintings (Peintures) Collection Scraper v2
 * 
...
const PROGRESS_FILE = path.join(PROGRESS_DIR, 'paintings-v2-progress.json');
 ...
 */
async function main() {
  console.log('🎨 Musée Picasso Paris - Paintings Collection Scraper v2');
