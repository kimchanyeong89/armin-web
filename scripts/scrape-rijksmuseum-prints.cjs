/**
 * Rijksmuseum Prints Collection Scraper - API 버전
 * Facet ID: a9f849002285adbd26678e361050083c
 */
...
const OUTPUT_FILE = path.join(__dirname, '../public/data/rijksmuseum-prints-collection.json');
const PROGRESS_FILE = path.join(__dirname, '../downloads/rijksmuseum-prints-progress.json');
const LOG_FILE = path.join(__dirname, '../downloads/rijksmuseum-prints-log.txt');
...
// Prints facet ID
const FACET_ID = 'a9f849002285adbd26678e361050083c';
...
async function main() {
  log('🖼️ Rijksmuseum Prints Collection Scraper - API 버전');
  log('='.repeat(60));
