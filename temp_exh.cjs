...
module.exports = [
  {
    ...
    permanentExhibitions: [
        ...
        name: 'mfah paintings',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from mfah-paintings.json',
        descriptionKo: 'mfah-paintings.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'mfah-paintings.json'
      }
      ],
  ...
  },
  {
    ...
    ,
        ...
        name: 'lacma japanese',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from lacma-japanese-prints.json',
        descriptionKo: 'lacma-japanese-prints.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'lacma-japanese-prints.json'
      }
      ,
        {
        id: 'lacma-drawings51',
        name: 'lacma drawings51',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from lacma-drawings-51.json',
        descriptionKo: 'lacma-drawings-51.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'lacma-drawings-51.json'
      }
      ,
        {
        id: 'lacma-list',
        name: 'lacma list',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from lacma-list.json',
        descriptionKo: 'lacma-list.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'lacma-list.json'
      }
      ],
    temporaryExhibitions: [],
    pastExhibitions: []
  ...
  },
  {
    ...
    ,
        ...
        name: 'mplus high',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from mplus-collection-highlights.json',
        descriptionKo: 'mplus-collection-highlights.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'mplus-collection-highlights.json'
      }
      ],
    temporaryExhibitions: [],
    pastExhibitions: []
  ...
  },
  {
    ...
    ,
        ...
        name: 'tate art',
        nameKo: '추가 소장품',
        description: 'Loaded from tate-artworks.json',
        descriptionKo: 'tate-artworks.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'tate-artworks.json'
      }
      ],
    temporaryExhibitions: [
    ],
  ...
  // Tate Britain
  {
    ...
    ,
        ...
        name: 'tate britain',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from tate-britain-artworks.json',
        descriptionKo: 'tate-britain-artworks.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'tate-britain-artworks.json'
      }
      ],
    temporaryExhibitions: [
    ],
  ...
  },
  {
    ...
    ,
        ...
        name: 'vam paintings',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from vam-paintings.json',
        descriptionKo: 'vam-paintings.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'vam-paintings.json'
      }
      ,
        {
        id: 'vam-portraits',
        name: 'vam portraits',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from vam-portraits.json',
        descriptionKo: 'vam-portraits.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'vam-portraits.json'
      }
      ,
        {
        id: 'vam-photographs',
        name: 'vam photographs',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from vam-photographs.json',
        descriptionKo: 'vam-photographs.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'vam-photographs.json'
      }
      ],
    temporaryExhibitions: [
  ...
  },
  {
    ...
    permanentExhibitions: [
      { id: "picasso-paris-collection", name: "The Collection", title: "Musée Picasso Paris - The Collection", description: "드로잉 1,492점, 회화 306점, 조각 340점, 판화 1,349점을 포함한 피카소 미술관 전체 컬렉션.", startDate: "Permanent", endDate: "Permanent" }
    ],
    temporaryExhibitions: [],
    pastExhibitions: [],
    exhibitions: []
  ...
  },
  {
    ...
    permanentExhibitions: [
      { id: "mamcs-strasbourg-collection", name: "전체 컬렉션", title: "MAMCS 스트라스부르 전체 컬렉션", description: "드로잉·회화·그래픽 디자인을 포함한 전체 컬렉션 6,097점.", startDate: "Permanent", endDate: "Permanent" }
    ],
    temporaryExhibitions: [],
    pastExhibitions: [],
    exhibitions: []
  },
  {
    ...
    permanentExhibitions: [
      { id: "bordeaux-collection", name: "The Collection", title: "Musée des Beaux-Arts de Bordeaux - The Collection", description: "르네상스부터 현대까지의 회화 2,296점 및 드로잉 3,302점 전체 컬렉션.", startDate: "Permanent", endDate: "Permanent" }
    ],
    temporaryExhibitions: [],
    pastExhibitions: [],
    exhibitions: []
  },
  {
    ...
    permanentExhibitions: [
      { id: "rodin-collection", name: "The Collection", title: "Musée Rodin - The Collection", description: "회화 224점, 조각, 판화 1,188점을 포함한 로댕 미술관 전체 컬렉션.", startDate: "Permanent", endDate: "Permanent" }
    ],
    temporaryExhibitions: [],
    pastExhibitions: [],
    exhibitions: []
  ...
  // Musée de l'Armée - Invalides
  {
    ...
    permanentExhibitions: [
      { id: "musee-armee-collection", name: "The Collection", title: "Musée de l'Armée Collection", description: "회화, 사진, 드로잉 등 1,476점의 군사 역사 소장품.", startDate: "Permanent", endDate: "Permanent" }
    ],
    temporaryExhibitions: [],
    pastExhibitions: [],
    exhibitions: []
  ...
  // South Korea - National Museum of Korea
  {
    ...
    ,
        ...
        name: 'nmk missing',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from national-museum-korea-missing.json',
        descriptionKo: 'national-museum-korea-missing.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'national-museum-korea-missing.json'
      }
      ],
    temporaryExhibitions: [],
    pastExhibitions: [],
  ...
  // Spain - Museo Nacional Centro de Arte Reina Sofía
  {
    ...
    ,
        ...
        name: 'reina full',
        nameKo: '추가 소장품',
        description: 'Loaded from reina-sofia-collection-full.json',
        descriptionKo: 'reina-sofia-collection-full.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'reina-sofia-collection-full.json'
      }
      ,
        {
        id: 'reina-on-display',
        name: 'reina on display',
        nameKo: '추가 소장품',
        description: 'Loaded from reina-sofia-on-display.json',
        descriptionKo: 'reina-sofia-on-display.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'reina-sofia-on-display.json'
      }
      ],
    temporaryExhibitions: [],
    pastExhibitions: [],
  ...
  },
  {
    ...
    location: "Boston, USA",
    description: "보스턴 미술관(MFA Boston)은 미국에서 가장 큰 미술관 중 하나로, 45만 점 이상의 작품을 소장하고 있습니다.",
    description_en: "The Museum of Fine Arts, Boston (MFA Boston), is one of the largest art museums in the United States, housing more than 450,000 works of art.",
    latitude: 42.3394,
    longitude: -71.0940,
    country: "USA",
    region: "Boston, Massachusetts",
    representativeImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Museum_of_Fine_Arts_Boston.jpg/1200px-Museum_of_Fine_Arts_Boston.jpg",
    floorPlan: "",
    permanentExhibitions: [],
    temporaryExhibitions: [],
    pastExhibitions: [],
  ...
  },
  {
    ...
    floorPlan: "",
    permanentExhibitions: [
      { id: "albertina-permanent-collection", name: "Permanent Collection", title: "ALBERTINA — Permanent Collection", description: "Highlights from the ALBERTINA's permanent collection spanning paintings, sculptures, drawings, prints, and objects & media art.", startDate: "Permanent", endDate: "Permanent" },
  ...
  },
  {
    ...
    ,
        {
        id: 'fine-arts-be-all',
        name: 'fine arts be all',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from fine-arts-be-complete.json',
        descriptionKo: 'fine-arts-be-complete.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'fine-arts-be-complete.json'
      }
      ],
    temporaryExhibitions: [],
    pastExhibitions: [],
  ...
  },
  {
    ...
    ,
        ...
        name: 'nga full col',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from nga-collection-full.json',
        descriptionKo: 'nga-collection-full.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'nga-collection-full.json'
      }
      ],
    temporaryExhibitions: [],
    pastExhibitions: []
  ...
  },
  {
    ...
    ,
        ...
        name: 'agnsw full',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from agnsw-collection-full.json',
        descriptionKo: 'agnsw-collection-full.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'agnsw-collection-full.json'
      }
      ],
    temporaryExhibitions: [],
    pastExhibitions: []
  ...
  },
  {
    ...
    permanentExhibitions: [
        ...
        name: 'cairo relics',
        nameKo: '전체 / 세부 소장품',
        description: 'Loaded from egyptian-museum-cairo-collection.json',
        descriptionKo: 'egyptian-museum-cairo-collection.json에서 불러온 소장품',
        date: 'Permanent',
        dataFile: 'egyptian-museum-cairo-collection.json'
      }
      ],
    temporaryExhibitions: [],
    pastExhibitions: []
