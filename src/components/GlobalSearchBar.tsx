...
// SearchWittyLoader (the ARMIN Knot search-loading mark) now lives in its own
// module so the Taste-Match tab can reuse the exact same loader. See import above.
