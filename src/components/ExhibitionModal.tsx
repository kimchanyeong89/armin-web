  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ position: "absolute", top: 0, bottom: 0, left: 0, width: 150, background: EM_BG, zIndex: 200, display: (isMobile || variant === 'sketch') ? 'none' : 'flex', flexDirection: 'column', pointerEvents: 'auto', ...(DEBUG_LAYOUT ? { outline: "1px solid #964B00" } : {}) }}>
