...
const CommunityList: React.FC<CommunityListProps> = ({ onPostClick, onWriteClick }) => {
    ...
    return (
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '16px', display: 'flex', flexDirection: 'column', height: '100%' }}>
            {/* Top Bar (Hidden if we rely on panel header, but kept to show Write button) */}
