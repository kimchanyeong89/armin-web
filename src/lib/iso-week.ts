// Pure ISO-8601 week utilities. No Node imports — safe to use from browser code
// (src/) and from Node scripts (scripts/weekly/). Single source of truth for
// week math across the weekly curation pipeline.
